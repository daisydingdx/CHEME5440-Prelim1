...
#u[1] = x; u[2] = y; u[3] = z
function Q2_f(du,u,p,t)

#given non-dimentional parameters
    S=105;   # 150->100 deltat=2
    alpha_x=0.039;
    alpha_y=4.3^(-3);
    beta_x=6.1;
    beta_y=5.7;
...
prob = ODEProblem(Q2_f,u0,tspan)     #Create an ODE problem for the Lorenz fxn
...
#It is possible using the parameters provided in Table S.1 to achieve coherent oscillation by decreasing the signal from 105 to 100.
